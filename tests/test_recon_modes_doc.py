...
def test_recon_modes_design_contract_exists_and_covers_required_terms() -> None:
    ...
    for expected in (
        ...
        "`hydra`",
        "`masscan`",
        "Phase 93D enables Deep Recon as `deep-bounded`",
        ...
        "Resume is fail-closed for interrupted Deep network stages",
        "preview-only JSON cannot reproduce the complete offline",
