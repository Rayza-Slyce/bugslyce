...
def test_readme_has_release_checkpoint_and_honest_limitations() -> None:
    ...
    assert "Current package version: `1.3.0`" in readme
    assert "BugSlyce `1.3.0` improves authorised-lab reliability" in compact
    assert "secondary provenance" in compact
