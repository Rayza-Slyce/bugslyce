...
DEEP_RECON_PLANNED_PIPELINE: tuple[DeepReconPlannedStep, ...] = (
    ...
    DeepReconPlannedStep(
        ...
        planned_outputs=("deep-output-service-inventory",),
    ...
    DeepReconPlannedStep(
        ...
        method_class="bounded service recon",
        uses_bounds=("request_timeout_seconds", "rate_limit_delay_seconds"),
        planned_outputs=("deep-output-service-version-context",),
    ...
    DeepReconPlannedStep(
        ...
        uses_bounds=(),
        planned_outputs=("deep-output-http-service-matrix",),
    ...
    DeepReconPlannedStep(
        ...
        planned_outputs=("deep-output-http-metadata",),
    ...
    DeepReconPlannedStep(
        ...
        method_class="GET/HEAD-style recon",
        uses_bounds=HTTP_BOUNDS,
        planned_outputs=("deep-output-common-metadata",),
    ...
    DeepReconPlannedStep(
        ...
        method_class="GET/HEAD-style recon",
        uses_bounds=HTTP_BOUNDS,
        planned_outputs=("deep-output-baseline-content-discovery",),
    ...
    DeepReconPlannedStep(
        ...
        method_class="GET/HEAD-style recon",
        uses_bounds=HTTP_BOUNDS,
        planned_outputs=("deep-output-discovered-path-context",),
    ...
    DeepReconPlannedStep(
        ...
        method_class="offline correlation",
        uses_bounds=(),
        planned_outputs=("deep-output-strong-signal-directory-set",),
    ...
    DeepReconPlannedStep(
        ...
        planned_outputs=("deep-output-second-pass-content-discovery",),
    ...
    DeepReconPlannedStep(
        ...
        planned_outputs=("deep-output-shallow-crawl-routes",),
    ...
    DeepReconPlannedStep(
        ...
        planned_outputs=("deep-output-selected-body-text",),
    ...
    DeepReconPlannedStep(
        ...
        method_class="offline correlation",
        uses_bounds=(),
        planned_outputs=("deep-output-js-source-reference-inventory",),
    ...
    DeepReconPlannedStep(
        ...
        planned_outputs=("deep-output-js-source-text",),
    ...
    DeepReconPlannedStep(
        ...
        method_class="offline correlation",
        uses_bounds=(),
        planned_outputs=("deep-output-static-route-inventory",),
    ...
    DeepReconPlannedStep(
        ...
        planned_outputs=("deep-output-source-map-context",),
    ...
    DeepReconPlannedStep(
        ...
        method_class="offline correlation",
        uses_bounds=(),
        planned_outputs=("deep-output-parameter-inventory",),
    ...
    DeepReconPlannedStep(
        ...
        method_class="offline correlation",
        uses_bounds=(),
        planned_outputs=("deep-output-form-inventory",),
    ...
    DeepReconPlannedStep(
        ...
        method_class="GET/HEAD-style recon",
        uses_bounds=HTTP_BOUNDS,
        planned_outputs=("deep-output-backup-config-source-checks",),
    ...
    DeepReconPlannedStep(
        ...
        method_class="offline correlation",
        uses_bounds=(),
        planned_outputs=("deep-output-route-source-service-correlation",),
    ...
    DeepReconPlannedStep(
        ...
        method_class="offline correlation",
        uses_bounds=(),
        planned_outputs=("deep-output-investigation-threads",),
    ...
    DeepReconPlannedStep(
        ...
        method_class="offline correlation",
        uses_bounds=(),
        planned_outputs=("deep-output-manual-review-queue",),
    ...
    DeepReconPlannedStep(
        ...
        uses_bounds=(),
        planned_outputs=("deep-output-report-section-set", "deep-output-runbook-section-set"),
    ...
    DeepReconPlannedStep(
        ...
        method_class="reporting",
        uses_bounds=(),
        planned_outputs=("deep-output-evidence-pack-manifest",),
